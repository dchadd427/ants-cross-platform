"""
Blender 4.3.2 Script: 360° Ray-Traced Cycles Turntable Generator
Renders 36 photorealistic path-traced frames (every 10 degrees) with Metal GPU.
Saves to web/viewer3d/turntable/frame_XX.png for smooth interactive browser scrubbing.
"""
...
out_dir = "/Users/dchadd/Desktop/Ants-Mac/web/viewer3d/turntable"
...
# 2. Camera Setup (Full heroic framing with ample headroom for antennae)
...
if not ant_col:
    print("Error: Worker_Ant_Authentic collection not found!")
    exit(1)
...
num_frames = 36
print(f"Starting 360° Cycles Metal GPU Turntable Render ({num_frames} frames)...")
...
print("360° Cycles Turntable rendering complete!")
