"""
Blender 4.3.2 Script: 360° Ray-Traced Cycles Turntable Generator for Fire Ant (Caste #2)
Renders 36 photorealistic path-traced frames (every 10 degrees) with Metal GPU.
Saves to web/viewer3d/turntable_fire/frame_XX.png for smooth interactive browser scrubbing.
"""
...
blend_file = "/Users/dchadd/Desktop/Ants-Mac/tools/blender/fire_ant_authentic.blend"
out_dir = "/Users/dchadd/Desktop/Ants-Mac/web/viewer3d/turntable_fire"
...
# 2. Camera Setup (Full heroic framing)
...
ant_col = bpy.data.collections.get("Fire_Ant_Authentic")
if not ant_col:
    print("Error: Fire_Ant_Authentic collection not found!")
    exit(1)
...
num_frames = 36
print(f"Starting 360° Cycles Metal GPU Turntable Render for Fire Ant ({num_frames} frames)...")
...
print("360° Cycles Turntable rendering for Fire Ant complete!")
