...
3. **Premise 3 (Specification):** Microsoft Ants authentic maps have maximum dimensions of 60×60. Enforcing `width <= 256 && height <= 256` guarantees `cell_count <= 65,536`, completely eliminating 32-bit and 64-bit integer overflow.
